    ...
    <div className="space-y-8 p-4 md:p-10">
      ...
      <div>
        ...
        <Animate>
          <p className="mt-2 text-lg text-gray-700">
            ...
            giving early access to new communities designed for growth,
            lifestyle, and long-term value. Each project is selected with care
            to align with both personal goals and market opportunity.
          </p>
        </Animate>
      </div>
      <div>
        ...
        <Animate>
          <p className="mt-2 text-lg text-gray-700">
            ...
            and often before it begins. This gives you the chance to secure a
            unit at a lower entry point than a ready-built home, with the
            potential for capital appreciation as the development progresses.
            Whether it’s a contemporary apartment or a high-end villa, off-plan
            properties are built to meet modern expectations in design, comfort
            and finish.
          </p>
        </Animate>
      </div>
      <div>
        ...
        <ul className="list-disc pl-5 mt-2 text-lg text-gray-700 space-y-2">
          ...
          <Animate>
            <li>
              <span className="font-semibold">Capital growth:</span> Benefit
              from increasing value as the project nears completion
            </li>
          </Animate>
        </ul>
