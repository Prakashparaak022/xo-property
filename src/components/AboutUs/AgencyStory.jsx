    ...
    <section className="w-full flex flex-col lg:flex-row items-start p-4 lg:p-10 gap-0 lg:gap-6">
      ...
      <div className="lg:w-1/2 space-y-4">
        <p className="text-lg text-gray-700">
          ...
          identified a gap in the market for a personable, flexible, and mature
          agency. We are committed to preserving the boutique values on which we
          were founded, ensuring that our clients always know they are our top
          priority. For many of our clients, this will be the largest purchase
          of their lives, and we are here to support them throughout the entire
          journey.
        </p>
      </div>
    </section>
